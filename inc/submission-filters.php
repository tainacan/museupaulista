...
if (class_exists('\Tainacan\Entities\Item')) {
	...
	function museupaulista_tainacan_submission_item_data( \Tainacan\Entities\Item $item, $data ) {
	...
	add_filter( 'tainacan-submission-item-data', 'museupaulista_tainacan_submission_item_data', 10, 2 );
}